...
Stream.prototype._init = function init() {
  ...
  this.once('end', function() {
    ...
    process.nextTick(function() {
      var onHeadersComplete = self.parser && (self.parser.onHeadersComplete ||
                                              self.parser[1]);
...
Stream.prototype._start = function start(url, headers) {
  ...
  var onHeadersComplete = this.parser && (this.parser.onHeadersComplete ||
                                          this.parser[1]);
...
Stream.prototype._recv = function _recv(data) {
  ...
  if (this.parser) {
    var onBody = this.parser.onBody || this.parser[2];
    if (onBody)
...
Stream.prototype._recvEnd = function _recv() {
  ...
  var onMessageComplete = this.parser && (this.parser.onMessageComplete ||
                                          this.parser[3]);
