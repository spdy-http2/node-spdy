...
//
// ### function replyFrame (stream, code, reason, headers)
...
//
Framer.prototype.replyFrame = function replyFrame(stream, code, reason,
                                                  headers) {
  var self = this,
      pairs = headers || {},
      size = 2;
...
//
// ### function dataFrame (stream, fin, data)
// #### @stream {Stream} SPDY Stream
// #### @fin {Bool} Is this data frame last frame
// #### @data {Buffer} Response data
// Sends DATA frame
//
Framer.prototype.dataFrame = function dataFrame(stream, fin, data) {
...
//
// ### function pingFrame (connection, id)
// #### @connection {Connection} SPDY Connection
// #### @id {Buffer} Ping ID
// Sends PING frame
//
Framer.prototype.pingFrame = function pingFrame(connection, id) {
...
//
// ### function rstFrame (stream, code)
// #### @stream {Stream} SPDY Stream
// #### @code {NUmber} RST Code
// Sends PING frame
//
Framer.prototype.rstFrame = function rstFrame(stream, code) {
  var header;
...
//
// ### function maxStreamsFrame (connection, count)
// #### @connection {Connection} SPDY Connection
// #### @count {Number} Max Concurrent Streams count
// Sends SETTINGS frame with MAX_CONCURRENT_STREAMS
//
Framer.prototype.maxStreamsFrame = function maxStreamsFrame(connection, count) {
  var settings;
