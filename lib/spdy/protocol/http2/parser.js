...
Parser.prototype.parseHeaders = function parseHeaders(header, body, callback) {
  ...
  this.unpadData(header, body, function(err, data) {
    ...
    self.initHeaderBlock(header, streamInfo, headerBlock, callback);
  });
};


//
// ### function initHeaderBlock (header, frame, block, callback)
// #### @header {Object} header object
// #### @frame {Object} frame object
// #### @block {Buffer} block of headers
// #### @callback {Function} continuation
//
...
//
// ### function queueHeaderBlock (header, block, callback)
// #### @header {Object} header data
// #### @block {Buffer} block of headers
// #### @callback {Function} continuation
//
Parser.prototype.queueHeaderBlock = function queueHeaderBlock(header,
  ...
  item.queue.push(block);
  item.size += block.length;
...
Parser.prototype.parseContinuation = function parseContinuation(data, callback) {
  this.queueHeaderBlock(header, data, callback);
};
