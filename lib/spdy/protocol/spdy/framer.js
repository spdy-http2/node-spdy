...
// #### @callback {Function}
// Sends connection Preface frame (relevant for HTTP2-only)
//
Framer.prototype.prefaceFrame = function prefaceFrame(options, callback) {
  return this.settingsFrame(options.settings, callback);
};
