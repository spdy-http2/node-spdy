...
Connection.prototype._onVersion = function _onVersion(version) {
  ...
  framer.settingsFrame({
    ...
    initial_window_size: state.initialWindowSize
  });
...
Connection.prototype._createStream = function _createStream(frame) {
  ...
  var stream = new Stream(this, frame.id);
...
Connection.prototype.request = function request(uri) {
  var state = this._spdyState;
...
Connection.prototype._destroyStreams = function _destroyStreams() {
