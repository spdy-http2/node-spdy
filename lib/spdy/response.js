 ...
 * Class constructor
 */
var Response = exports.Response = function(cframe, c, csettings) {
...
exports.createResponse = function(cframe, c, csettings) {
  return new Response(cframe, c, csettings);
};
...
Response.prototype._flushHead = function() {
  ...
  var sframe = createSettingsFrame(this.c.zlib,
                                   this.csettings);

  if (this.c.write(cframe) > 0) {
    return this.c.write(sframe);
  };
  return -1;
};
